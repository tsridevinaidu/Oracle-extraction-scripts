...
-- Script to extract Triggers & Trigger Functions belongs to LABORADMIN role to execute on Postgresq1
...
BEGIN
  ...
  FOR rec IN (
    ...
    FROM all_triggers
    WHERE owner = 'LABORADMIN'  ORDER BY TRIGGER_NAME-- Replace with your schema name
  ) LOOP
