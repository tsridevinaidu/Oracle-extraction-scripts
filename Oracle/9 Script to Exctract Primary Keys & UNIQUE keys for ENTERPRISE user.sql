...
-- Script to extract Primary Keys and UNIQUE Keys belongs to ENTERPRISE role  


SELECT 
    'ALTER TABLE ' || owner || '.' || table_name || 
    ' ADD CONSTRAINT ' || constraint_name || ' PRIMARY KEY (' || LISTAGG(column_name, ', ') 
...
FROM (
    ...
    WHERE 
        ...
        AND c.owner = 'ENTERPRISE'      -- Replace 'OPER' with your schema name
