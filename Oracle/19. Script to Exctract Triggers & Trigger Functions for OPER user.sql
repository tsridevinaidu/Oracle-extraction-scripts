...
-- Script to extract Triggers & Trigger Functions belongs to OPER role to execute on Postgresq1
...
BEGIN
  ...
  FOR rec IN (
    ...
    FROM all_triggers
    WHERE owner = 'OPER'  ORDER BY TRIGGER_NAME-- Replace with your schema name
  ) LOOP
