...
-- Script to create Primary Keys and UNIQUE keys belongs to LABORADMIN role.
...
FROM (
    ...
    WHERE 
        ...
        AND c.owner = 'LABORADMIN' -- Replace 'META' with your schema name
)
GROUP BY 
...
FROM (
    ...
    WHERE 
        ...
        AND c.owner = 'LABORADMIN'      -- Replace 'LABORADMIN' with your schema name
