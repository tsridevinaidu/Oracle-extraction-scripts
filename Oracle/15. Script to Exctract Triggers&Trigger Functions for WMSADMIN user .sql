...
-- Script to extract Triggers & Trigger Functions belongs to WMSADMIN role to execute on Postgresq1
...
BEGIN
  ...
  FOR rec IN (
    ...
    FROM all_triggers
    WHERE owner = 'WMSADMIN'  ORDER BY TRIGGER_NAME-- Replace with your schema name
  ) LOOP
