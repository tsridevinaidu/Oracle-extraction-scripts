...
-- Script to create Primary Keys and UNIQUE keys belongs to WMSADMIN role.
...
FROM (
    ...
    WHERE 
        ...
        AND c.owner = 'WMSADMIN' -- Replace 'WMSADMIN' with your schema name
)
GROUP BY 
...
FROM (
    ...
    WHERE 
        ...
        AND c.owner = 'WMSADMIN'      -- Replace 'OPER' with your schema name
