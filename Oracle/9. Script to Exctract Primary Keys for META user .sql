...
-- Script to extract Primary Keys belongs to META role
...
FROM (
    ...
    WHERE 
        ...
        AND c.owner = 'META' -- Replace 'META' with your schema name
)
GROUP BY 
...
FROM (
    ...
    WHERE 
        ...
        AND c.owner = 'META'      -- Replace 'OPER' with your schema name
