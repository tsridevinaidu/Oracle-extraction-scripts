...
-- Script to extract Primary Keys belongs to OPER role 
...
FROM (
    ...
    WHERE 
        ...
        AND c.owner = 'OPER' -- Replace 'META' with your schema name
)
GROUP BY 
...
FROM (
    ...
    WHERE 
        ...
        AND c.owner = 'OPER'      -- Replace 'OPER' with your schema name
