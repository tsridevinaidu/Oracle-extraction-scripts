...
-- Script to extract tables belongs to WMWHSE1 role and all datatypes will be converted to map Postgresq1

-- to view the output, DBMS output should be enabled. 

-- The query should be run at Oracle

-- Script to extract tables belongs to WMSADMIN role and all datatypes will be converted to map Postgresq1
